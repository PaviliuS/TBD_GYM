...
namespace TBD_GYM
{
    public partial class Form1 : Form
    {
        ...
        {
            sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["GYMDB"].ConnectionString);
            sqlConnection.Open();
        ...
        {
            view("select * from v_trainers");
        }
        private void button9_Click(object sender, EventArgs e)
        {
            view("select * from v_lessons");
        }
        ...
        {
            procedure($"EXECUTE p_sales @new_client = N'{textBox1.Text}', @new_group = N'{textBox2.Text}', @new_employee = N'{textBox3.Text}', @new_extras = N'{textBox4.Text}';");
        }
